...
@section('page-subtitle', 'Ubah data gaji')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm">
        ...
        <form action="{{ route('gajis.update', $gaji) }}" method="POST" class="p-6 space-y-4">
            @csrf
            @method('PUT')

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Nama Gaji <span class="text-red-500">*</span></label>
                <input type="text" name="name" value="{{ $gaji->name }}"
            ...
            <div>
                ...
                <input type="number" name="amount" value="{{ $gaji->amount }}" step="0.01" min="0"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
